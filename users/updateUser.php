                        ...
                        <?php
                            ...
                            if($users) {
                                foreach ($users as $user) { ?>
                                    <form id="<?php echo $user['_id'] ?>" name="editUserForm" method="POST" class="user-form my-4" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            <input type="hidden" class="form-control col-md-10" id="userId" placeholder="Enter user name" name="userId" value="<?php echo $user['_id'] ?>">
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label col-md-2" for="userName">User Name</label>
                                            <input type="text" class="form-control col-md-10" id="userName" placeholder="Enter user name" name="userName" value="<?php echo $user['userName'] ?>">
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label col-md-2" for="firstName">First Name</label>
                                            <input type="text" class="form-control col-md-10" id="firstName" placeholder="Enter first name" name="firstName" value="<?php echo $user['firstName'] ?>">
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label col-md-2" for="lastName">Last Name</label>
                                            <input type="text" class="form-control col-md-10" id="lastName" placeholder="Enter last name" name="lastName" value="<?php echo $user['lastName'] ?>">
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label col-md-2" for="email">Email</label>
                                            <input type="email" class="form-control col-md-10" id="email" placeholder="Enter email" name="email" value="<?php echo $user['email'] ?>">
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label col-md-2" for="mobileNo">Mobile No</label>
                                            <input type="text" class="form-control col-md-10" id="mobileNo" placeholder="Enter mobile no" name="mobileNo" value="<?php echo $user['mobileNo'] ?>">
                                        </div>
                                        <div class="form-group row">
