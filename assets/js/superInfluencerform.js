$(document).ready(function(e){
    ...
    $("#superInfluencerRegistrationForm").validate({
        rules:{
            firstName: "required",
            lastName: "required",
            middleName: "required",
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                ...
                beforeSend: function(){
                    ...
                    $('#superInfluencerRegistrationForm').css("opacity",".5");
                },
                success: function(response){ 
                    console.log("Response is" + response);
                    $("#superInfluencerRegistrationForm")[0].reset();
                    $('#superInfluencerRegistrationForm').css("opacity","");
