...
<head>
    ...
    <title>Suppliers | Hypermartindia</title>
                    ...
                    <tbody>
                        <?php
                            ...
                            foreach ($suppliers as $supplier) { ?>
                                <tr id="<?php echo $supplier['_id'] ?>">
                                    <td> <?php echo $supplier['firstName']." ".$supplier['middleName']." ".$supplier['lastName']?></td>
                                    <td> <?php echo $supplier['email'] ?> </td>
                                    <td> <?php echo $supplier['mobileNo'] ?> </td>
                                    <td> <?php echo $supplier['companyName'] ?> </td>
                                    <td> <?php echo $supplier['addressLineOne']."<br>".$supplier['addressLineTwo']."<br>".$supplier['city']."<br>".$supplier['pincode']?></td>
                                    <td> <?php echo $supplier['supplierCode'] ?> </td>
                                    <?php if($_SESSION['userRole'] == 'edit' || $_SESSION['userRole'] == 'create') { ?>
                                        <td><a href="updateSupplier.php?id=<?php echo $supplier['supplierCode']; ?>" class="btn btn-primary editSupplier" id="edit<?php echo $supplier['_id'] ?>">Edit</a></td>  
                                    <?php } ?>
                                    <?php if($_SESSION['userRole'] == 'admin') { ?>
                                        <td><a href="updateSupplier.php?id=<?php echo $supplier['supplierCode']; ?>" class="btn btn-primary editSupplier" id="edit<?php echo $supplier['_id'] ?>">Edit</a>
                                            <button href="delete.php" class="btn btn-danger delete" id="<?php echo $supplier['_id'] ?>">Delete</button></td>
                                    <?php } ?>
                                </tr>
                            <?php }
                        ?>                 
