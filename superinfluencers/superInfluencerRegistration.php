...
<html lang="en">
  <head>
    ...
    <title>Super Influencer Registration | Hypermartindia</title>
  ...
  <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 mx-auto">
                        <p><b>Intended super influencer personal details:</b></p>
                        <p class="alert-message"></p>
                        <form id="superInfluencerRegistrationForm" method="POST" class="registration-form my-4" enctype="multipart/form-data">
    ...
    <script src="../assets/js/superInfluencerform.js"></script>
