  ...
  <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 mx-auto">
                        <p><b>Edit influencer personal details:</b></p>
                        <div class="alert-message"></div>
                        <?php 
                            $id=$_REQUEST['id'];
                            $collection = $db->influencerRegister;
                            $query = array("influencerCode" => $id);
                            $influencers = $collection->find($query); 
                            if($influencers) {
                                foreach ($influencers as $influencer) { ?>
                                    <form id="<?php echo $influencer['influencerCode'] ?>" class="editForms" name="editInfluencerForm" method="POST" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            <input type="hidden" class="form-control col-md-10" id="influencerCode" placeholder="Enter first name" name="influencerCode" value="<?php echo $influencer['influencerCode'] ?>">
                                        </div>    
                                        <div class="form-group row">
                                            <label class="control-label col-md-2" for="firstName">First Name</label>
                                            <input type="text" class="form-control col-md-10" id="firstName" placeholder="Enter first name" name="firstName" value="<?php echo $influencer['firstName'] ?>">
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label col-md-2" for="middleName">Middle Name</label>
                                            <input type="text" class="form-control col-md-10" id="middleName" placeholder="Enter middle name" name="middleName" value="<?php echo $influencer['middleName'] ?>">
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label col-md-2" for="lastName">Last Name</label>
                                            <input type="text" class="form-control col-md-10" id="lastName" placeholder="Enter last name" name="lastName" value="<?php echo $influencer['lastName'] ?>">
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label col-md-2" for="dateOfBirth">Date of Birth</label>
                                            <input type="date" class="form-control col-md-10" id="dateOfBirth" placeholder="Enter date of birth" name="dateOfBirth" value="<?php echo $influencer['dateOfBirth'] ?>">
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label col-md-2" for="email">Email</label>
                                            <input type="email" class="form-control col-md-10" id="email" placeholder="Enter email" name="email" value="<?php echo $influencer['email'] ?>">
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label col-md-2" for="mobileNo">Mobile No</label>
                                            <input type="text" class="form-control col-md-10" id="mobileNo" placeholder="Enter mobile no" name="mobileNo" value="<?php echo $influencer['mobileNo'] ?>">
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label col-md-2" for="addressLineOne">Address Line 1</label>
                                            <input type="text" class="form-control col-md-10" id="addressLineOne" placeholder="Enter address line one" name="addressLineOne" value="<?php echo $influencer['addressLineOne'] ?>">
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label col-md-2" for="addressLineTwo">Address Line 2</label>
                                            <input type="text" class="form-control col-md-10" id="addressLineTwo" placeholder="Enter address line two" name="addressLineTwo" value="<?php echo $influencer['addressLineTwo'] ?>">
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label col-md-2" for="city">City</label>
                                            <input type="text" class="form-control col-md-10" id="city" placeholder="Enter city" name="city" value="<?php echo $influencer['city'] ?>">
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label col-md-2" for="pincode">Pincode</label>
                                            <input type="text" class="form-control col-md-10" id="pincode" placeholder="Enter pincode" name="pincode" value="<?php echo $influencer['pincode'] ?>">
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input type="text" class="form-control col-md-10" id="bankName" placeholder="Enter bank name" name="bankName" value="<?php echo $influencer['bankName'] ?>">
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label col-md-2" for="bankAddress">Address of bank</label>
                                            <input type="text" class="form-control col-md-10" id="bankAddress" placeholder="Enter bank address" name="bankAddress" value="<?php echo $influencer['bankAddress'] ?>">
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label col-md-2" for="accountType">Acocunt type</label>
                                            <input type="text" class="form-control col-md-10" id="accountType" placeholder="Enter account type" name="accountType" value="<?php echo $influencer['accountType'] ?>">
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label col-md-2" for="accountNumber">Account Number</label>
                                            <input type="text" class="form-control col-md-10" id="accountNumber" placeholder="Enter bank account number" name="accountNumber" value="<?php echo $influencer['accountNumber'] ?>">
                                        </div>
                                        <div class="form-group row">
                                            <label class="control-label col-md-2" for="ifscCode">IFSC code</label>
                                            <input type="text" class="form-control col-md-10" id="ifscCode" placeholder="Enter ifsc code" name="ifscCode" value="<?php echo $influencer['ifscCode'] ?>">
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4 pl-0">
                                                <img src="<?php echo $influencer['signature'] ?>" alt="signature" width="30%">
                                            </div>
                                        </div>
                                        <div id="influencerDiv" class="form-group row">
                                            ...
                                            <div class="col-md-10 pl-0">
                                                <?php 
                                                    ...
                                                    if($influencer['superInfluencer'] !== "") {
                                                        $superInf = $collection->findOne(['_id' => new MongoDB\BSON\ObjectId($influencer['superInfluencer'])]);
                                                        echo $superInf['firstName']." ".$superInf['middleName']." ".$superInf['lastName'];
                                                    }
                                                ?>
                                                <select class="form-control col-md-4 my-3" name="superInfluencers">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(e){
            $("form[name='editInfluencerForm']").validate({
                rules:{
                    firstName: "required",
                    lastName: "required",
                    middleName: "required",
