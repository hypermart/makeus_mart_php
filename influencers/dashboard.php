...
<head>
    ...
    <title>Influencers | Hypermartindia</title>
                    ...
                    <tbody>
                        <?php
                            foreach ($influencers as $influencer) { ?>
                                <tr id="<?php echo $influencer['_id'] ?>">
                                    <td> <?php echo $influencer['firstName']." ".$influencer['middleName']." ".$influencer['lastName']?></td>
                                    <td> <?php echo $influencer['email'] ?> </td>
                                    <td> <?php echo $influencer['mobileNo'] ?> </td>
                                    <td> <?php echo $influencer['addressLineOne']."<br>".$influencer['addressLineTwo']."<br>".$influencer['city'].",".$influencer['pincode']?> </td>
                                    <td> <?php echo $influencer['influencerCode'] ?> </td>
                                    <?php if($_SESSION['userRole'] == 'edit' || $_SESSION['userRole'] == 'create') { ?>
                                        <td><a href="updateInfluencer.php?id=<?php echo $influencer['influencerCode']; ?>" class="btn btn-primary editInfluencer" id="edit<?php echo $influencer['_id'] ?>">Edit</a></td>  
                                    <?php } ?>
                                    <?php if($_SESSION['userRole'] == 'admin') { ?>
                                        <td><a href="updateInfluencer.php?id=<?php echo $influencer['influencerCode']; ?>" class="btn btn-primary editInfluencer" id="edit<?php echo $influencer['_id'] ?>">Edit</a>
                                            <button href="delete.php" class="btn btn-danger delete" id="<?php echo $influencer['_id'] ?>">Delete</button></td>
                                    <?php } ?>
                                </tr>
                        <?php } ?>
                    </tbody>
